...
class SortingVisualizerCLI {
    static Scanner sc = new Scanner(System.in);

    static long rec_start;
    static int actualTimeTrack;

    static void main()
    {
        int[] arr;
        arr = ipArray(0);
        System.out.println("1 - Want actual time tracking of the algorithms.");
        System.out.println("2 - Will prefer algorithm time tracking along with time taken to print algorithm steps.");
        actualTimeTrack = sc.nextInt();
        unknownAlgoCall(arr);
    }
    ...
    static void processAlgo(int[] arr, int algorithm)
    {
        ...
        else if(actualTimeTrack == 1){
            switch (algorithm) {
                case 1:
                    ActualAlgorithmsWithoutPrinting.bubbleSort(arr);
                    break;
                case 2:
                    System.out.println("1. - Min Based \n2. - Max Based");
                    type = sc.nextInt();
                    if (type == 1) ActualAlgorithmsWithoutPrinting.selectionSort_min(arr);
                    if (type == 2) ActualAlgorithmsWithoutPrinting.selectionSort_max(arr);
                    break;
                case 3:
                    System.out.println("1. - Swap Based \n2. - Shifting Based");
                    type = sc.nextInt();
                    if (type == 1) ActualAlgorithmsWithoutPrinting.insertionSort_swap(arr);
                    if (type == 2) ActualAlgorithmsWithoutPrinting.insertionSort_shift(arr);
                    break;
                case 4:
                    System.out.println("1. - Naive Auxiliary Array Based \n2. - Indices Based \n3. - Bottom Up Merge Sort");
                    type = sc.nextInt();
                    if (type == 1) {
                        System.out.println("It is recursion - DFS(depth first search), so all levels doesnt appears together");
                        rec_start = System.nanoTime();
                        ActualAlgorithmsWithoutPrinting.mergeSort_AuxArray(arr, 1);
                        long end = System.nanoTime();
                        System.out.println("Time: " + (end - rec_start) / 1_000_000.0 + " ms\n");
                    }
                    if (type == 2) {
                        rec_start = System.nanoTime();
                        ActualAlgorithmsWithoutPrinting.mergeSort_IndicesBased(arr, 0, n - 1, 1);
                        long end = System.nanoTime();
                        System.out.println("Time: " + (end - rec_start) / 1_000_000.0 + " ms\n");
                    }
                    if (type == 3) mergeSort_bottomUp(arr);
                ...
                case 5:
                    ...
                    if (type == 1) {
                        rec_start = System.nanoTime();
                        ActualAlgorithmsWithoutPrinting.quickSort_Naive(arr, 0, n - 1, 1);
                        long end = System.nanoTime();
                        System.out.println("Time: " + (end - rec_start) / 1_000_000.0 + " ms\n");
                    }
                    if (type == 2) {
                        rec_start = System.nanoTime();
                        ActualAlgorithmsWithoutPrinting.quickSort_Lomuto(arr, 0, n - 1, 1);
                        long end = System.nanoTime();
                        System.out.println("Time: " + (end - rec_start) / 1_000_000.0 + " ms\n");
                    }
                    if (type == 3) {
                        rec_start = System.nanoTime();
                        ActualAlgorithmsWithoutPrinting.quickSort_Hoare(arr, 0, n - 1, 1);
                        long end = System.nanoTime();
                        System.out.println("Time: " + (end - rec_start) / 1_000_000.0 + " ms\n");
                    }
                    break;
                case 6:
                    ...
                    ActualAlgorithmsWithoutPrinting.countingSort(arr, min, max);
                    break;
                case 7:
                    ActualAlgorithmsWithoutPrinting.radixSort(arr);
                    break;
                default:
                    System.out.println("Invalid input, please give input in integer format 1 to 7");
            }
...
class ActualAlgorithmsWithoutPrinting{
    static void bubbleSort(int[] arr)
    {
        long start = System.nanoTime();
